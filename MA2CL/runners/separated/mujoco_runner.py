        ...
        while True:
            ...
            if eval_episode >= self.all_args.eval_episodes:
                ...
                eval_env_infos = {
                    ...
                    "faulty_node_-1/eval_average_episode_rewards": eval_episode_rewards,
                    "eval_max_episode_rewards": [np.max(eval_episode_rewards)],
                    "faulty_node_-1/eval_max_episode_rewards": [np.max(eval_episode_rewards)],
                }
                self.log_env(eval_env_infos, total_num_steps)
                mean_eval_episode_rewards = np.mean(eval_episode_rewards)
                print(f"eval_average_episode_rewards is {mean_eval_episode_rewards}.")
                break
