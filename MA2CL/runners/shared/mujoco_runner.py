    ...
    def eval(self, total_num_steps, faulty_node):
        ...
        while True:
            ...
            if eval_episode >= self.all_args.eval_episodes:
                key_average = (
                    "faulty_node_" + str(faulty_node) + "/eval_average_episode_rewards"
                )
                key_max = (
                    "faulty_node_" + str(faulty_node) + "/eval_max_episode_rewards"
                )
                eval_env_infos = {
                ...
                print(
                    "faulty_node {} eval_average_episode_rewards is {}.".format(
                        faulty_node, np.mean(eval_episode_rewards)
                    )
                )
                break
